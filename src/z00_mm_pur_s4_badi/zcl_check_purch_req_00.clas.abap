CLASS zcl_check_purch_req_00 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_check_purch_req_00 IMPLEMENTATION.


  METHOD if_mm_pur_s4_pr_check~check.

    CHECK sy-uname = 'CB9980000041'.

    DATA ls_message TYPE mmpur_s_messages.

** Partner Globalization Workshop Dubai

    READ TABLE  purchaserequisitionitem_table  INTO DATA(ls_pur_req_itm) INDEX 1    .

    IF ls_pur_req_itm-orderedquantity > 11.
      ls_message-messageid = 'DUMMY'.
      ls_message-messagetype = 'E'.
      ls_message-messagenumber = '001'.
      ls_message-messagevariable1 = ' Dubai Partner Workshop - the quantity limit is 11'.           "Place holder
