CLASS zcl_sy_bog_pur_check DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_sy_bog_pur_check IMPLEMENTATION.
...
METHOD if_mm_pur_s4_pr_check~check.
    ...
    IF rem = 1.
      ...
      ls_message-messagevariable1 = ' Message from group SYBVEN: Only order an even number of items '.
