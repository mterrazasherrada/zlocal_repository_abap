CLASS zcl_check_purch_req_bb13 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_check_purch_req_bb13 IMPLEMENTATION.
...
**
    ...
    IF ls_pur_req_itm-orderedquantity > 10.
      ...
      ls_message-messagevariable1 = ' BB13- Quantity limit 10'.           "Place holder
    ...
    IF ls_pur_req_itm-deliverydate - ( cl_abap_context_info=>get_system_date( ) ) > 180.
      ...
      ls_message-messagevariable1 = 'BB13 - Delivery date limit 180 days '.           "Place holder
