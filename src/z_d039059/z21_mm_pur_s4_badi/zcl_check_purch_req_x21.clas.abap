CLASS zcl_check_purch_req_x21 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_CHECK_PURCH_REQ_X21 IMPLEMENTATION.
...
**
    ...
    IF ls_pur_req_itm-orderedquantity > 10.
      ...
      ls_message-messagevariable1 = ' NO BIG THAT 10'.
    ...
    IF ls_pur_req_itm-deliverydate - ( cl_abap_context_info=>get_system_date( ) ) > 180.
      ...
      ls_message-messagetype = 'E'.
      ls_message-messagenumber = '001'.
      ls_message-messagevariable1 = 'not later than 180 days '.           "Place holder
      APPEND ls_message TO messages.
