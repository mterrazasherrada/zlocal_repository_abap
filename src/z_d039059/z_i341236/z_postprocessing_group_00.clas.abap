CLASS z_postprocessing_group_00 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS z_postprocessing_group_00 IMPLEMENTATION.
  ...
  METHOD if_dmee_output_postprocessing~modify_output.
    ...
    DATA: file_string   TYPE string,
          ...
          hash          TYPE string,
          declaration   TYPE string VALUE '<?xml version="1.0" encoding="UTF-8"?>'.
    ...
    REPLACE ALL OCCURRENCES OF declaration IN file_string WITH ''.
