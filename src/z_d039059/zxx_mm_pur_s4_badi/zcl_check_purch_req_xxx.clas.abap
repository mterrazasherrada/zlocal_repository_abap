...
IF ls_pur_req_itm-orderedquantity > 10.
  ...
  ls_message-messagevariable1 = ' Quantity limit 10. pls correct..Khaleel'.           "Place holder
...
IF ls_pur_req_itm-deliverydate - ( cl_abap_context_info=>get_system_date( ) ) > 180.
  ...
  ls_message-messagetype = 'E'.
  ls_message-messagenumber = '001'.
  ls_message-messagevariable1 = 'Delivery date limit 180 days. pls correct...Khaleel '.           "Place holder
  APPEND ls_message TO messages.
