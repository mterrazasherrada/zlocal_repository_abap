CLASS zcl_17_bog_pur_check DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_17_bog_pur_check IMPLEMENTATION.
  ...
  DATA     rem    type p decimals 2.
    ...
    rem = ( ls_pur_req_itm-orderedquantity mod 1 ).

    IF rem = 1.
      ls_message-messageid = 'DUMMY'.
      ls_message-messagetype = 'I'.
      ls_message-messagenumber = '001_17'.
      ls_message-messagevariable1 = ' Message from group 17_SAP_TEAM: Only order an even number of items '.
