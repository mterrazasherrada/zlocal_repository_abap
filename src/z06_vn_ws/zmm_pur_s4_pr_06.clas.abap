CLASS zmm_pur_s4_pr_06 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zmm_pur_s4_pr_06 IMPLEMENTATION.
  ...
  READ TABLE  purchaserequisitionitem_table  INTO DATA(ls_pur_req_itm) INDEX 1    .
    ...
    IF ls_pur_req_itm-orderedquantity > 10.
      ...
      ls_message-messagevariable1 = ' Quantity limit 10 ( user 06 )'.           "Place holder
    ...
    IF ls_pur_req_itm-deliverydate - ( cl_abap_context_info=>get_system_date( ) ) > 180.
      ...
      ls_message-messagetype = 'E'.
      ls_message-messagenumber = '001'.
      ls_message-messagevariable1 = 'Delivery date limit 180 days( user 06 ) '.           "Place holder
      APPEND ls_message TO messages.
