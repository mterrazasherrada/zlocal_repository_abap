CLASS zcl_check_purch_req_c07 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_check_purch_req_c07 IMPLEMENTATION.
...
**
    ...
    IF ls_pur_req_itm-orderedquantity > 10.
      ...
      ls_message-messagevariable1 = ' Quantity limit 10 (HVN)'.           "Place holder
    ...
    IF ls_pur_req_itm-deliverydate - ( cl_abap_context_info=>get_system_date( ) ) > 180.
      ...
      ls_message-messagevariable1 = 'Delivery date limit 180 days (HVN)'.           "Place holder
