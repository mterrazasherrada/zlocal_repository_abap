...
CLASS lsc_ZI_ONLINE_SHOP_G62 DEFINITION INHERITING FROM cl_abap_behavior_saver.
  PROTECTED SECTION.
...
CLASS lsc_ZI_ONLINE_SHOP_G62 IMPLEMENTATION.

  METHOD save_modified.
     DATA : lt_online_shop_as TYPE STANDARD TABLE OF zshop_as_g62,
            ls_online_shop_as TYPE zshop_as_g62.

     IF zbp_i_online_shop_g62=>cv_pr_mapped-purchaserequisition IS NOT INITIAL.
         LOOP AT zbp_i_online_shop_g62=>cv_pr_mapped-purchaserequisition ASSIGNING FIELD-SYMBOL(<fs_pr_mapped>).
     ...
     IF create-online_shop IS NOT INITIAL.
         ...
         INSERT zshop_as_g62 FROM TABLE @lt_online_shop_as.
     ENDIF.
 ENDMETHOD.
