CLASS zcl_shop_api_read_H26 DEFINITION
PUBLIC
CREATE PUBLIC .
  PUBLIC SECTION.
  ...
  PRIVATE SECTION.
ENDCLASS.
CLASS zcl_shop_api_read_H26 IMPLEMENTATION.
  METHOD if_http_service_extension~handle_request.
    ...
    TRY.
        ...
        comm_scenario = 'Z_SHOP_SCENARIO_OUTBOUND_H26'
        service_id = 'Z_SHOP_API_READ_OBS_H26_REST' ).
        lo_http_client = cl_web_http_client_manager=>create_by_http_destination( lo_destination ).
        lo_client_proxy = cl_web_odata_client_factory=>create_v2_remote_proxy(
        EXPORTING
        iv_service_definition_name = 'Z_SHOP_API_SCM_H26'
