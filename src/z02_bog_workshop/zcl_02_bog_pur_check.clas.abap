CLASS zcl_02_bog_pur_check DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_02_bog_pur_check IMPLEMENTATION.
...
*    IF rem = 1.
      ...
      ls_message-messagevariable1 = ' Message from group 02: Only order an even number of items '.
