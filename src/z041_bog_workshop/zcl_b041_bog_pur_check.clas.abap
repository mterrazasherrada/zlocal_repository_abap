CLASS zcl_b041_bog_pur_check DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_b041_bog_pur_check IMPLEMENTATION.
...
**
    ...
    IF ls_pur_req_itm-orderedquantity > 100.
      ls_message-messageid = 'DUMMY'.
      ls_message-messagetype = 'E'.
      ls_message-messagenumber = '001'.
      ls_message-messagevariable1 = ' Quantity limit 100 (User 041)'.           "Place holder
    ...
    IF ls_pur_req_itm-deliverydate - ( cl_abap_context_info=>get_system_date( ) ) > 180.
      ...
      ls_message-messagetype = 'E'.
      ls_message-messagenumber = '001'.
      ls_message-messagevariable1 = 'Delivery date limit 180 days (User 041)'.           "Place holder
      APPEND ls_message TO messages.
