CLASS zcl_check_purch_req_b15 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC.
...
CLASS zcl_check_purch_req_b15 IMPLEMENTATION.
  ...
  METHOD if_mm_pur_s4_pr_check~check.
    ...
    IF ls_pur_req_itm-orderedquantity > 10.
      ...
      ls_message-messagevariable1 = 'Quantity limit 10 (B15)'.             "Place holder
    ...
    IF ls_pur_req_itm-deliverydate - ( cl_abap_context_info=>get_system_date( ) ) > 180.
      ...
      ls_message-messagetype      = 'E'.
      ls_message-messagenumber    = '001'.
      ls_message-messagevariable1 = 'Delivery date limit 180 days (B15)'.  "Place holder
      APPEND ls_message TO messages.
    ENDIF.
