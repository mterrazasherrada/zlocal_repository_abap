CLASS zcl_08_bog_pur_check_sjp DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_08_bog_pur_check_sjp IMPLEMENTATION.
  ...
  METHOD if_mm_pur_s4_pr_check~check.
      ...
      DATA ls_message TYPE mmpur_s_messages.
        ...
        IF rem = 1.
          ls_message-messageid = 'DUMMY2'.
          ls_message-messagetype = 'I'.
          ls_message-messagenumber = '001'.
          ls_message-messagevariable1 = ' Message from group 08_SJP: Only order an even number of items '.
