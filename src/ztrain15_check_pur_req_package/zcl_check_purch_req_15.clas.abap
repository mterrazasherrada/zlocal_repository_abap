CLASS zcl_check_purch_req_15 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_CHECK_PURCH_REQ_15 IMPLEMENTATION.
...
**
    ...
    IF ls_pur_req_itm-orderedquantity > 20.
      ls_message-messageid = 'DUMMY'.
      ls_message-messagetype = 'E'.
      ls_message-messagenumber = '001'.
      ls_message-messagevariable1 = ' Quantity limit 20'.           "Place holder
