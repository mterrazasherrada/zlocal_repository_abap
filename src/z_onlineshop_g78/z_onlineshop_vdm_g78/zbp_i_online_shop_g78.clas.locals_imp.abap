...
CLASS lsc_ZI_ONLINE_SHOP_G78 DEFINITION INHERITING FROM cl_abap_behavior_saver.
  PROTECTED SECTION.
...
CLASS lsc_ZI_ONLINE_SHOP_G78 IMPLEMENTATION.

  METHOD save_modified.

    DATA : lt_online_shop_as TYPE STANDARD TABLE OF zshop_as_G78,
    ls_online_shop_as TYPE zshop_as_G78.
    IF zbp_i_online_shop_G78=>cv_pr_mapped-purchaserequisition IS NOT INITIAL.
        LOOP AT zbp_i_online_shop_G78=>cv_pr_mapped-purchaserequisition ASSIGNING FIELD-SYMBOL(<fs_pr_mapped>).
    ...
    IF create-online_shop IS NOT INITIAL.
        ...
        INSERT zshop_as_G78 FROM TABLE @lt_online_shop_as.
    ENDIF.
